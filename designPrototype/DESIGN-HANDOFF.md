# 256891fd-9ead-45cb-912b-f3c858b4ad7f implementation handoff

This archive is the source of truth for turning the design into production code. Start from `bubble-trouble-arcade-2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `bubble-trouble-arcade-2.html`
...
- A single self-contained `bubble-trouble-arcade-2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `bubble-trouble-arcade-2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `bubble-trouble-arcade-2.html`
- `bubble-trouble-arcade.html`
...
- `image.png`
- `screenshot-2026-08-12T15-07-06-421Z.png`
- `screenshot-2026-08-12T15-07-18-691Z.png`

## Coding checklist for AI tools
1. Inspect `bubble-trouble-arcade-2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
