...
**Reason**: Classic redesign removes walkable platforms; variety comes from barriers/doors and ball counts.
**Migration**: Author levels with `barriers` and `doors` only.

### Requirement: Obstacles
**Reason**: Folded into barriers/doors vocabulary.
**Migration**: Convert former obstacles to barriers or doors in level data.
