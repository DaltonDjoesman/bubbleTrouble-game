...
- [ ] 3.1 Play calls `reset_match` with selected mode/level (level 1 default if pack absent)
- [ ] 3.2 From won/game over: retry key + return-to-menu key
- [ ] 3.3 Manual smoke: boot→menu→play→die/win→menu→quit
